...
_Текущий контур (апрель 2026):_ карточка «Мои проекты» в SPA ЛК по-прежнему ходит в `robbo_personal_account_backend` (GraphQL + REST для `project_page`); исправление сохранения инструкции/примечания зафиксировано в `change_log.md` за эту же дату.
